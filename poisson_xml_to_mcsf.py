...
with open('circlemesh_uninverted.m', 'w+') as file:
	...
	for vert in Original_vertices:
		file.write(vert + '    0    ' + Original_vertices[vert][0] + '  ' + Original_vertices[vert][1] + '  ' + '0' + '\n')
	file.write('];\n\n')
	file.write('simp=[\n')
	for tetra in Tetrahedrons_:
		file.write(tetra + '      0   0   ' + str(Boundary_bool[Tetrahedrons_[tetra][0]]) + '  ' + str(Boundary_bool[Tetrahedrons_[tetra][1]]) + '  ' + str(Boundary_bool[Tetrahedrons_[tetra][2]]) + '  ' + '  ' + Tetrahedrons_[tetra][0] + '  ' + Tetrahedrons_[tetra][1] + '  ' + Tetrahedrons_[tetra][2] + '\n')
	file.write('];\n\n')
